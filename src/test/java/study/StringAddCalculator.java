...
public class StringAddCalculator {
    static int delimiternum = 1;
    static int textnum = 2;
    ...
    public static int splitAndSum(String text) {
        ...
        Matcher pattern = Pattern.compile(customPattern).matcher(text);
        ...
        if (isPatternMatched(pattern)) {
            ...
            notPatternSum = textIntoIntAndSumAll(text);
        }
        if (patternSum > 0) {
            return patternSum;
        }
    ...
    private static int textIntoIntAndSumAll(String text) {
